...
#include "learning_based_vehicle_calibration/msg/detail/longitudinal_progress__rosidl_typesupport_fastrtps_c.h"
...
using _LongitudinalProgress__ros_msg_type = learning_based_vehicle_calibration__msg__LongitudinalProgress;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LongitudinalProgress__ros_msg_type * ros_message = static_cast<const _LongitudinalProgress__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: velocity_start
  {
    cdr << ros_message->velocity_start;
  }

  // Field name: velocity_end
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LongitudinalProgress__ros_msg_type * ros_message = static_cast<_LongitudinalProgress__ros_msg_type *>(untyped_ros_message);
  // Field name: pedal_value_start
  {
    cdr >> ros_message->pedal_value_start;
  }
...
static uint32_t _LongitudinalProgress__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_learning_based_vehicle_calibration__msg__LongitudinalProgress(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = learning_based_vehicle_calibration__msg__LongitudinalProgress;
    is_plain =
      (
...
static size_t _LongitudinalProgress__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_learning_based_vehicle_calibration__msg__LongitudinalProgress(
...
static message_type_support_callbacks_t __callbacks_LongitudinalProgress = {
...
static rosidl_message_type_support_t _LongitudinalProgress__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LongitudinalProgress,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learning_based_vehicle_calibration, msg, LongitudinalProgress)() {
  return &_LongitudinalProgress__type_support;
}
