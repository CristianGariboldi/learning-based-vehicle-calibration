...
static const _SteeringProgress_type_support_symbol_names_t _SteeringProgress_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learning_based_vehicle_calibration, msg, SteeringProgress)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, learning_based_vehicle_calibration, msg, SteeringProgress)),
  }
};
...
{
  return &::learning_based_vehicle_calibration::msg::rosidl_typesupport_cpp::SteeringProgress_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, learning_based_vehicle_calibration, msg, SteeringProgress)() {
  return get_message_type_support_handle<learning_based_vehicle_calibration::msg::SteeringProgress>();
}
