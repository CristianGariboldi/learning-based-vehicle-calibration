...
static const _LongitudinalProgress_type_support_symbol_names_t _LongitudinalProgress_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learning_based_vehicle_calibration, msg, LongitudinalProgress)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, learning_based_vehicle_calibration, msg, LongitudinalProgress)),
  }
};
...
{
  return &::learning_based_vehicle_calibration::msg::rosidl_typesupport_cpp::LongitudinalProgress_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, learning_based_vehicle_calibration, msg, LongitudinalProgress)() {
  return get_message_type_support_handle<learning_based_vehicle_calibration::msg::LongitudinalProgress>();
}
