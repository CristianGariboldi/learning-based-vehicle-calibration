...
#include "learning_based_vehicle_calibration/msg/detail/steering_progress__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const learning_based_vehicle_calibration::msg::SteeringProgress & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  learning_based_vehicle_calibration::msg::SteeringProgress & ros_message)
{
  // Member: pedal_value_start
  cdr >> ros_message.pedal_value_start;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = learning_based_vehicle_calibration::msg::SteeringProgress;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const learning_based_vehicle_calibration::msg::SteeringProgress *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<learning_based_vehicle_calibration::msg::SteeringProgress *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SteeringProgress__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const learning_based_vehicle_calibration::msg::SteeringProgress *>(
...
static size_t _SteeringProgress__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SteeringProgress(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SteeringProgress__callbacks = {
...
static rosidl_message_type_support_t _SteeringProgress__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SteeringProgress__callbacks,
...
get_message_type_support_handle<learning_based_vehicle_calibration::msg::SteeringProgress>()
{
  return &learning_based_vehicle_calibration::msg::typesupport_fastrtps_cpp::_SteeringProgress__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, learning_based_vehicle_calibration, msg, SteeringProgress)() {
  return &learning_based_vehicle_calibration::msg::typesupport_fastrtps_cpp::_SteeringProgress__handle;
}
